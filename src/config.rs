...
impl Default for OrganizationConfig {
    fn default() -> Self {
        Self {
            ...
            tv_shows_template: "{title}/Season {season:02}/{title} S{season:02}E{episode:02} {episode_title}".to_string(),
...
impl AppConfig {
    ...
    pub fn load() -> Result<Self> {
        ...
        config_builder = config_builder.add_source(Environment::with_prefix("PLEX_MEDIA_ORGANIZER"));
    ...
    pub fn get_database_path(&self) -> Result<PathBuf> {
        let config_dir = Self::get_config_dir()?;
        let db_path = self.database.database_path
            .clone()
...
mod tests {
    ...
    fn test_config_defaults() {
        ...
        assert_eq!(config.organization.quality.preferred_quality, Some("1080p".to_string()));
    }
    ...
    fn test_config_serialization() {
        ...
        assert_eq!(config.learning.confidence_threshold, deserialized.learning.confidence_threshold);
    }
}
